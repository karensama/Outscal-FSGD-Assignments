...
class Enemy
{
    ...
    Enemy()
    {
        cout<<"Ha ha ha I'm the enemy! I don't have an evil introduction yet as my creator is still thinking about my great debut!"<<endl; 
    }
    ...
    void TakeDamage(int damage)
    {
        ...
        {
            health = health - damage;
            cout<<"Enemy's current health is "<<health<<endl; 
        }
        else
        {
    ...
    int GiveDamage()
    {
        srand(time(0));
        int randomDamage = (rand() % (maxDamage - minDamage + 1) + minDamage);
        cout<<"The enemy is attacking. Damage dealt is "<<randomDamage<<endl;
    ...
    void Heal()
    {
        ...
        int randomHeal = (rand() % (maxHealing - minHealing +1) + minHealing);
        health = health + randomHeal;
        cout<< "The enemy healed "<<randomHeal<<" HP. Their current health is "<<health<<"."<<endl;
    }
